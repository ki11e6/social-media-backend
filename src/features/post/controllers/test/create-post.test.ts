...
//fake all involve asynchronous code that relies on timers
jest.useFakeTimers();
// all these services will be mocked so no real time execution happens.
jest.mock('@service/queues/base.queue');
jest.mock('@service/redis/post.cache');
jest.mock('@global/helpers/cloudinary-upload');

//creating new property postServer and moking it so we can check if emit is called.
